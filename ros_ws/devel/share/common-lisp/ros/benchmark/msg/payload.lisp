...
(cl:defmethod cl:initialize-instance :after ((m <payload>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'payload)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name benchmark-msg:<payload> is deprecated: use benchmark-msg:payload instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <payload>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader benchmark-msg:header-val is deprecated.  Use benchmark-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <payload>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader benchmark-msg:data-val is deprecated.  Use benchmark-msg:data instead.")
  (data m))
